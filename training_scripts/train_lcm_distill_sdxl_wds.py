...
def group_by_keys_nothrow(data, keys=base_plus_ext, lcase=True, suffixes=None, handler=None):
    ...
    for filesample in data:
        ...
        key_names = list(filesample.keys())
        if not 'fname' in key_names:
            print("---------------------------------")
            print(f"DEBUG: filesample keys = {list(filesample.keys())}")
            print("---------------------------------")
            continue
...
def log_validation(vae, unet, args, accelerator, weight_dtype, step, name="target"):
    ...
    validation_prompts = [
        ...
        "masterpiece, best quality, amazing quality, cinematic lighting, anime style, (blurred background), (dramatic lighting), (field of flowers, day, clear day, rays of sunshine, open field), 1 girl, solo, woman, flower in hand, (a look of devotion, looking at viewer), artoria pendragon (fate), saber (fate), blonde hair, green eyes, ahoge, hair ribbon, blue ribbon, french braid, braided bun, single hair bun, short hair, sidelocks, turtleneck, blue dress, breastplate, armored dress, long sleeves, juliet sleeves, gauntlets, smelling flowers,",
